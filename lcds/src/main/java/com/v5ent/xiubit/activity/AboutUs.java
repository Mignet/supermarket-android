...
//        }
        ...
        textWechatWeContent.setText(MyApp.getInstance().getDefaultSp().getWechatNumber());  //微信公众号
        textMailWeContent.setText(MyApp.getInstance().getDefaultSp().getServiceMail()); //客服邮箱
